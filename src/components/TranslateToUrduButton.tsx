...
const TranslateToUrduButton: React.FC<TranslateToUrduButtonProps> = ({
  ...
  const buttonLabel = isUrduVersion ? (
    <Translate
      id="theme.TranslateToEnglishButton.label"
      description="The label for the translate to English button"
    >
      انگریزی میں تبدیل کریں
    </Translate>
  ) : (
    <Translate
      id="theme.TranslateToUrduButton.label"
      description="The label for the translate to Urdu button"
    >
      اردو میں تبدیل کریں
    </Translate>
  );
