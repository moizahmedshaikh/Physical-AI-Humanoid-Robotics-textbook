...
const Chatbot = () => {
  ...
  const handleSendMessage = async (query, context = null) => {
    ...
    const endpoint = isSelectionQuery
      ? "http://127.0.0.1:8000/query-selection"
      : "http://127.0.0.1:8000/query";
    const body = isSelectionQuery
      ? { selected_text: context, query: query || null }
      : { query };
      ...
      setMessages([
        {
          sender: "bot",
          answer:
            "👋🏻 Hello! I'm your Physics AI Assistant. Ask me anything about physics or select text to get specific explanations.",
          sources: [],
        },
      ]);
    }
    ...
    <>
      ...
      <button
        ...
        className={`chatbot-toggle-btn ${
          isOpen ? "chatbot-toggle-btn-open" : ""
        }`}
      >
        {isOpen ? (
          <svg
          ...
          <div className="chatbot-messages-container">
            {messages.length === 0 ? (
              <div className="chatbot-welcome">
                ...
                <p>
                  Ask me anything about physics or select text to get specific
                  explanations.
                </p>
              </div>
            ) : (
